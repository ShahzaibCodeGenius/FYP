...
export default function UploadZone({ onFileSelected, onSampleSelected, disabled }) {
  ...
  return (
    <div>
      ...
      >
        ...
        <p className="upload-zone__title">Drop your microscopy image here</p>
        <p className="upload-zone__sub">or click to browse &mdash; RGB JPG, PNG, WEBP up to 15MB</p>
      </motion.div>

      <div className="upload-sample">
        <div className="upload-sample__copy">
          <span className="upload-sample__eyebrow">TRY A SAMPLE</span>
          <strong>Featured lung tissue image</strong>
          <span>RGB illustration with cellular detail</span>
        </div>
        <img src={SAMPLE_IMAGE_URL} alt="Lung tissue microscopy sample" className="upload-sample__image" />
        <button type="button" className="upload-sample__button" onClick={onSampleSelected} disabled={disabled}>
          Use sample image
        </button>
      </div>
